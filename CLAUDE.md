...
- `Ctrl-a` — show all info overlay (level, SRS stage, components, meanings, readings, mnemonics; for kanji subjects also lists vocabulary that uses the kanji; for vocab subjects also shows the readings of each component kanji); ↑↓/j/k to scroll, Ctrl-a/Esc/Enter to close
